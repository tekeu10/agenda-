...
import viewextends.CalendarCustomise;
...
public class Main extends javax.swing.JFrame {
    ...
    private CalendarCustomise form3;
    ...
    public Main() {
        ...
        form1 = new Form_1();
        form2 = new Form_2();
        form3 = new CalendarCustomise();
        menu.initMoving(Main.this);
        menu.addEventMenuSelected((int index) -> {
            switch (index) {
                case 0 -> setForm(home);
                case 1 -> setForm(form2);
                case 2 -> setForm(form1);
                case 4 -> setForm(form3);
                default -> {
                }
            }
        });
