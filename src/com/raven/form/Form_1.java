...
public class Form_1 extends javax.swing.JPanel {
    ...
    private void init() {
        chart.addLegend("Evenement", new Color(12, 84, 175), new Color(0, 108, 247));
        chart.addLegend("EN ATTENTE", new Color(54, 4, 143), new Color(104, 49, 200));
        chart.addLegend("MANQUE", new Color(5, 125, 0), new Color(95, 209, 69));
        chart.addLegend("TERMINE", new Color(186, 37, 37), new Color(241, 100, 120));
        chart.addData(new ModelChart("AOUT", new double[]{500, 200, 80, 89}));
        chart.addData(new ModelChart("Septembre", new double[]{600, 750, 90, 150}));
        chart.addData(new ModelChart("Octobre", new double[]{200, 350, 460, 900}));
        chart.addData(new ModelChart("Novembre", new double[]{480, 150, 750, 700}));
        chart.addData(new ModelChart("Decembre", new double[]{350, 540, 300, 150}));
        chart.addData(new ModelChart("Janvier", new double[]{190, 280, 81, 200}));
        chart.start();
        lineChart.addLegend("évenement", new Color(12, 84, 175), new Color(0, 108, 247));
        lineChart.addLegend("EN ATTENTE", new Color(54, 4, 143), new Color(104, 49, 200));
        lineChart.addLegend("MANQUE", new Color(5, 125, 0), new Color(95, 209, 69));
        lineChart.addLegend("TERMINE", new Color(186, 37, 37), new Color(241, 100, 120));
        lineChart.addData(new ModelChart("AOUT", new double[]{500, 200, 80, 89}));
        lineChart.addData(new ModelChart("Septembre", new double[]{600, 750, 90, 150}));
        lineChart.addData(new ModelChart("Octobre", new double[]{200, 350, 460, 900}));
        lineChart.addData(new ModelChart("Novembre", new double[]{480, 150, 750, 700}));
        lineChart.addData(new ModelChart("Decembre", new double[]{350, 540, 300, 150}));
        lineChart.addData(new ModelChart("Janvier", new double[]{190, 280, 81, 200}));
        lineChart.start();
        progress1.start();
        progress2.start();
        progress3.start();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Total des évènements");
        ...
        jLabel2.setText("Rapport du Mois");
        ...
        jLabel3.setText("Evènements terminé");
        ...
        jLabel4.setText("Evènements manqués");
